...
<body>
   ...
   <div class="container-fluid">
      <div class="form-group">
         <center>
            <h3 class="page-header">Gerenciar categorias</h3>
         </center>
      </div>
      <br/><br/>
      ...
      <table id="myTable" class="table cell-border stripe hover" width="100%">
         <thead>
            <tr>
               ...
               <th scope="col">Primeira categoria</th>
               <th scope="col">Segunda categoria</th>
               <th>Editar</th>
               <th>Excluir</th>
            </tr>
         </thead>
         ...
         <tr>
            <td><?php echo $cont++; ?></td>
            <td><?php echo $sql['pri_cat']; ?></td>
            <td><?php echo $sql['sec_cat'];  ?></td>
            <td><button type="button" class="btn btn-warning editar" data-target="#model" data-toggle="modal" value="<?php echo $sql['cod_cat']?>">Editar</button></td>
            <td><button type="button" class="btn btn-danger excluir" value="<?php echo $sql['cod_cat']?>" data-target="#conf" data-toggle="modal" value="<?php echo $sql['cod_cat']?>">Excluir</button></td>
         </tr>
         <?php } ?>
         </tbody>
      </table>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="container-fluid" width="100%">
                  <form name="form1" class="formulario" enctype="multipart/form-data" method="post" data-parsley-validate="" action="../funcionalidade/editarcategoria.php">
                     <div class="form-group">
                        <br/>
                        <div class="row">
                           <div class="col-md-2">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control primeira" name="primeira" placeholder="Primeira categoria" maxlength="150" required/>
                              </div>
                              <div class="form-group">
                                 <label for="exampleFormControlSelect1">Segunda categoria:</label>
                                 <input type="text" class="form-control segunda" name="segunda"  placeholder="Segunda categoria" maxlength="150" required/>
                              </div>
                              </br>
