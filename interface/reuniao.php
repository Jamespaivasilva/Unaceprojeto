...
<head>
   ...
   <!-- CSS -->
   <link rel="stylesheet" href="../css/reuniao.css">
   <!-- CSS do Bootstrap -->
...
<body>
   ...
   <div class="container-fluid">
      <form name="form1" enctype="multipart/form-data" class="formulario" method="post" action="../funcionalidade/reuniao.php">
         <div class="form-group">
            <div class="row">
               <div class="col-md-4"></div>
               <div class="col-md-4">
                  <center>
                     <h3 class="page-header">Agendar reunião</h3>
                  </center>
               </div>
            </div>
            <br/>
            <div class="row">
               ...
               <div class="col-md-8">
                  ...
                  <?php if(isset($_GET['resultado'])){ if($_GET['resultado']=="success"){echo '<div class="alert alert-success" role="alert">Reunião agendada com sucesso!</div>';}else{
                     echo '<div class="alert alert-danger" role="alert">Reunião não agendada!</div>';
                     } } ?>
                  <div class="form-group">
                     <label for="exampleFormControlSelect1">Título</label>
                     <input type="text" class="form-control titulo2" name="titulo" maxlength="110" placeholder="Título" required>
                  </div>
                  <div class="form-group">
                     <label for="exampleFormControlSelect1">Grupo:</label>
                     <select name="grupo" class="form-control grupo" id="exampleFormControlSelect1" required>
                  ...
                  <div class="form-group">
                     <label class="categoria" for="exampleFormControlSelect1">Local</label>
                     <select name="endereco" class="form-control endereco" id="exampleFormControlSelect1" required>
                        <!-- Passar todos os valores de categória -->
            ...
            <div class="row">
               <div class="col-md-4"></div>
               <div class="col-md-4"><button  type="button" style="width:100%" class="btn btn-success cadastrar">Cadastrar</button></div>
      </form>
      </div>
      </div>
   </div>
 <!------------------------------------------------------------------- Script---------------------------------------------------------------------------->    
   ...
   <script src="../scripts/reuniao.js"></script>
</body>
<br/><br/><br/>
