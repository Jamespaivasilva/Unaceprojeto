...
<body>
   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-md-4">
            <center>
               <h3 class="page-header">Cadastrar grupo</h3>
            </center>
         </div>
      </div>
      <br/><br/>
      <div class="row">
         <div class="col-md-4"></div>
         <div class="col-md-4">
            <form action="../funcionalidade/grupo.php" method="post" data-parsley-validate="" >
               <?php if(isset($_GET['resultado'])){echo '<div class="alert alert-success" role="alert">Grupo cadastrado com sucesso!</div>';}?>
               <br/>
               <label for="exampleFormControlSelect1">Nome do grupo:</label>
               <input type="text" class="form-control" name="nome" placeholder="Nome do grupo" maxlength="60" required>
               <br/>
               <label for="exampleFormControlSelect1">Data de fundação:</label>
               <input type="date"  class="form-control" name="fundacao" placeholder="Data de fundação" required>
               <br/>
